...
async function * files() {
	for (const f of [
		...
		'data5.swf',
		'data6.swf',
		'metru_nui_loader_eng.xml',
		'Metru_nui_ep1_eng.xml',
		'Metru_nui_ep2_eng.xml',
		'Metru_nui_ep3_eng.xml',
		'Metru_nui_ep4_eng.xml',
		'Metru_nui_ep5_eng.xml',
		'Metru_nui_ep6_eng.xml'
	]) {
		yield [f, await fse.readFile(`original/files/onlinemovies/${f}`)];
	}
	for (const f of [
...
gulp.task('build:windows', async () => {
	...
	b.projector.patchWindowTitle = appNameShorter;
